/****************************************************************************
** Meta object code from reading C++ file 'connectsocket.h'
**
...
#error "The header file 'connectsocket.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_connectSocket[] = {
    "connectSocket\0\0disconnectedSignal(int)\0"
...
void connectSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->disconnectedSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
...
// SIGNAL 0
void connectSocket::disconnectedSignal(int _t1)
{
